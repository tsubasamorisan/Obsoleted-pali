...
if __name__ == '__main__':
  ...
  if sys.argv[1] == "pot":
    os.system('xgettext --from-code=UTF-8 --keyword=_ --output=locale/messages.pot `find ./templates -name "*.html"` templates/js/palidict.js templates/js/palidictSearch.js')
