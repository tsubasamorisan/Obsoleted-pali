...
input_js1 =  '--js static/js/data2dom.js'
input_js2 =  '--js static/js/dropdown.js'
input_js3 =  '--js static/js/draggable.js'
input_js4 =  '--js static/js/inputsuggest.js'
input_js5 =  '--js static/js/lookup.js'
input_js6 =  '--js static/js/palidict.js'
...
partial_cmd = '%s %s %s %s %s %s %s %s' % (compiler, input_base, input_js1, input_js2, input_js3, input_js4, input_js5, input_js6)
